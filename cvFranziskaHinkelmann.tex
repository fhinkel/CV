...
%85774 Unterf\"ohring, Germany 
	...
	{\it Twitter:} \href{https://twitter.com/fhinkel}{@fhinkel}
...
\begin{outerlist}
 ...
 \href{http://www.informatica-feminale.de/en/summer2014/lib/ajax/course_eng.php?courseId=533}{Agile Software Development: A Node.js application in one week}	\\
\end{outerlist}
...
\begin{outerlist}
	\item[]
	{\bf Postdoctoral Fellow}, 2011-2014\\
...
%
Collaborator on \href{http://www.nsf.gov/awardsearch/showAward.do?AwardNumber=1146819&WT.z_pims_id=5444}{NSF Award \#1146819} \textit{Collaborative Research: ABI Innovation: PlantSimLab: A Simulation Laboratory for Plant Biology}\\
...
\textbf{F. Hinkelmann}, E. Arnold, 2010, under review\\
\newpage
...
\textit{\href{http://arxiv.org/abs/0912.2089}{Boolean Models of Bistable
...
%\begin{outerlist}
%\item[] 
%	\textit{Bifurcation Theory for Polynomial Dynamical Systems}, {\bf F. Hinkelmann}, R. Laubenbacher, in preparation
%
%\item[] 
%	\textit{Optimal Control for Polynomial Dynamical Systems}, {\bf F. Hinkelmann}, H. Al-Asadi, A. Kumano, L. Ohm, A. Toms, M. %Oremland, R. Laubenbacher, in preparation

%\item[] 
%	\textit{Computation of Siphons in Petri Nets Using Algebraic Methods}, {\bf F. Hinkelmann}, A. Shiu, M. Heiner, R. %Laubenbacher, in preparation\\
%%
%% M2 paper
%% Primary Decomp paper
%% Boolean Steady States
%\end{outerlist}
...
\textit{\href{http://admg.vbi.vt.edu/home/Outreach/Workshops/cancer-systems-biology/Worksheet.pdf?attredirects=0&d=1}{Mathematical Modeling in Cancer Biology}}, March 25th, 2011,
Winston-Salem, NC  \\
...
PlantSimLab Software Demonstration}, April 9th, 2013, Big Sky, MT\\

\textbf{Plant Immunity: Pathways and Translation}, Keystone Symposium, Poster {\it PlantSimLab: a simulations laboratory for plant biology}, April 9th, 2013, Big Sky, MT\\

\textbf{MBI (Mathematical Biosciences Institute)}, Postdoctoral seminar, November 8th, 2012, Columbus, OH\\

\textbf{Society for Mathematical Biology}, Annual Meeting, Session for {\it Agent-based Models of Biological Systems: Approximation and Control}, {\it Algebraic Framework for Agent-based models}, July 26th, 2012, Knoxville, TN\\

\textbf{Ohio State University}, RUMBA Undergraduate Seminar in Mathematical Biology, {\it Inhibiting tumor growth of melanoma cells}, April 3rd, 2012, Columbus, OH\\

\textbf{MBI}, Institute Partner Meeting, Poster {\it Using Systems Biology Approach to Identify Potential Targets for Therapy in Melanoma cells}, February 12th, 2012, Columbus, OH\\
